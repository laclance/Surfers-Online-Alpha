...
import com.coesolutions.surfersonline.repository.database.UserDAO;
import com.coesolutions.surfersonline.repository.database.impl.UserDAOImpl;
import com.coesolutions.surfersonline.service.impl.UserServiceImpl;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private class CheckUserAsync extends AsyncTask<Void, String, Void> {
        @Override
        protected void onPreExecute() {
            progressTextView.setText("Please wait, loading ...");
        ...
        protected Void doInBackground(Void ... params) {
            ...
            if (!user.equals("")) {
                String password = dao.findUserByUsername(user).getPassword();
                if (ManagePreferences.readFromPreferences(getApplicationContext(), "REMEMBER_USER", false)) {
                    publishProgress(user, password);
                }
            }
            return null;
        }
