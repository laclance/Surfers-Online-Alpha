package com.coesolutions.surfersonline.repository.impl;
...
import com.coesolutions.surfersonline.repository.RestUserAPI;

import java.util.ArrayList;
import java.util.List;

public class RestUserAPIImpl implements RestUserAPI {
    final String BASE_URL="http://surfersonlinebackendapi-coesolutions.rhcloud.com/api/";
